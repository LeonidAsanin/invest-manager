...
public class AccountController {
    ...
    public String accountPage(
        ...
        purchaseList = PurchaseSaleUtil.sortPurchaseList(purchaseList, loggedUserManagementService.getSortType());
        saleList = PurchaseSaleUtil.sortSaleList(saleList, loggedUserManagementService.getSortType());
